...
# O(N ^ (T/M)
# Space: O(N ^ (T/M))
# The code uses a backtracking algorithm to find all possible combinations. The time complexity can be analyzed by considering the decision tree generated by the recursive calls.
        ...
        def backtrack(start_index, cur_comb, cur_sum):
            if cur_sum == target:
                ...
                for i in range(start_index, len(candidates)):
                    ...
                    backtrack(i, cur_comb, cur_sum + candidate)
                    cur_comb.pop()
